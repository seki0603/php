...
foreach($status_codes as $status_code){
    ...
    if($status_code["code"] === $option && $option !== $answer_code){
        $incorrect_code = $status_code["code"];
        $incorrect_description = $status_code["description"];
    }
}
$result = $option === $code;
        ...
        <div class="result__content">
            ...
            <div class="answer-table">
                <table class="answer-table__inner">
                    ...
                    <?php if (!$result): ?>
                    <tr class="answer-table__row">
                        <th class="answer-table__header">選んだコード</th>
                        <td class="answer-table__text">
                            <?php echo $incorrect_code ?>
                        </td>
                    </tr>
                    <tr class="answer-table__row">
                        <th class="answer-table__header">説明</th>
                        <td class="answer-table__text">
                            <?php echo $incorrect_description ?>
                        </td>
                    </tr>
                    <?php endif; ?>
                </table>
